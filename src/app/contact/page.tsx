      ...
      <div className="max-w-6xl w-full mx-auto p-6 bg-white shadow-md rounded-lg relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
          ...
          <div className="relative">
            ...
            <p className="text-lg font-bold text-[#C4B494] mb-4"> We &apos;re Love to Hear From You!</p>
          ...
          <div className="bg-[#F3EDE4] p-8 rounded-xl shadow-md flex flex-col justify-center">
            ...
            {isClicked && <p className="mt-4 text-green-600">Thank you for your message! We will get back to you shortly.</p>}
          </div>
        </div>
